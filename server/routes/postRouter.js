...
const { createPost, getAllPosts, getPostById, commentOnPost, deletePost, editPost, getTopThreePosts, getProfile, postExplore, getFollowingPosts } = require('../controllers/postController');

const postRoutes = express.Router();

postRoutes.get('/all', getAllPosts);
postRoutes.get('/following',isUserLogged,getFollowingPosts);
